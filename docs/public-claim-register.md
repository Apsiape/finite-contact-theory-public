...
(v0.34) is allowed to say. Every claim is scoped. A label stronger than the
...
The v0.34 public ceiling is (quoted identically in the README, the chapter-56
paper, and the v0.34.0 release notes):
...
The v0.1–v0.33 ceilings remain quoted, unchanged, in their frozen chapters
