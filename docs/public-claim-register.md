...
(v0.23) is allowed to say. Every claim is scoped. A label stronger than the
...
The v0.23 public ceiling is (quoted identically in the README, the chapter-33
paper, and the v0.23.0 release notes):
...
The v0.1–v0.22 ceilings remain quoted, unchanged, in their frozen chapters
