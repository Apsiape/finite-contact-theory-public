...
(v0.35) is allowed to say. Every claim is scoped. A label stronger than the
...
The v0.35 public ceiling is (quoted identically in the README, the chapter-61
paper, and the v0.35.0 release notes):
...
The v0.1–v0.34 ceilings remain quoted, unchanged, in their frozen chapters
