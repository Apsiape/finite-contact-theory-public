...
*diverges* from quantum mechanics. The newest lines (Chapters 20-22) complete the
...
1. [papers/22-price-of-chance/paper.md](papers/22-price-of-chance/paper.md) — **Chapter 22** (v0.19): the price of chance — the measure dilemma, the field carrier, and the earned key (the newest result).
...
This is v0.19.0: twenty-two chapters — three recovery axes, the extension
