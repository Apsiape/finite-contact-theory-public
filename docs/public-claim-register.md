...
(v0.22) is allowed to say. Every claim is scoped. A label stronger than the
...
The v0.22 public ceiling is (quoted identically in the README, the chapter-31
paper, and the v0.22.0 release notes):
...
The v0.1–v0.21 ceilings remain quoted, unchanged, in their frozen chapters
