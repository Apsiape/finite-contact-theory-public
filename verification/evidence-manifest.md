...
The public repository now spans sixty-one chapters (this manifest details the
...
- `verification/scripts/ledger_books.py` (chapter 57)
- `verification/scripts/valuation_prices.py` (chapter 58)
