...
1. [papers/24-particles-of-floor/paper.md](papers/24-particles-of-floor/paper.md) — **Chapter 24** (v0.20): the particles of the floor — wounds, charge, bound states, and the opposition calculus (the newest result).
...
This is v0.20.0: twenty-four chapters — three recovery axes, the extension
