...
(v0.28) is allowed to say. Every claim is scoped. A label stronger than the
...
The v0.28 public ceiling is (quoted identically in the README, the chapter-42
paper, and the v0.28.0 release notes):
...
The v0.1–v0.27 ceilings remain quoted, unchanged, in their frozen chapters
