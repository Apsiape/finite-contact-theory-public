...
[chapter-15](papers/15-ladder-of-scars/paper.md) and
[chapter-16](papers/16-debt-ledger/paper.md) papers, and the
[v0.16.0 release notes](RELEASE-NOTES-v0.16.0.md):
...
dichotomy). All in exact
arithmetic in a few seconds. This is the shipped public subset —
...
1. [papers/15-ladder-of-scars/paper.md](papers/15-ladder-of-scars/paper.md) · [papers/16-debt-ledger/paper.md](papers/16-debt-ledger/paper.md) — **Chapters 15–16** (v0.16): the ladder of scars and the debt ledger (the newest results).
...
This is v0.16.0: sixteen chapters — three recovery lines, a first extension
line, a count-regions line, a floor-to-interface line, the atlas of
floors, and now the ladder of scars and the debt ledger (one obstruction
tower, witness-readable at every rung, and its exact price column) — 84
claim rows (FCT-01..84), 63 theorem rows (T-01..63), twenty-one shipped
...
The latest minted version DOI is v0.15.0's,
[10.5281/zenodo.21402979](https://doi.org/10.5281/zenodo.21402979); the
v0.16.0 version DOI is recorded at mint in [CITATION.cff](CITATION.cff)
and the chapter freeze records
([15](papers/15-ladder-of-scars/RELEASE.md),
[16](papers/16-debt-ledger/RELEASE.md)).
