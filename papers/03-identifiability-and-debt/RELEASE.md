...
| Theorem rows | T-18, T-19, T-20, T-21 |
| Shipped verification | `verification/identifiability_debt_calculus.py` (frozen copy; live copy in `/verification/scripts/`) |
