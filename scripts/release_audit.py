...
REQUIRED_FILES = [
    "papers/23-decay-of-worlds/paper.md",
    "papers/23-decay-of-worlds/claims.md",
    "papers/23-decay-of-worlds/RELEASE.md",
    "papers/23-decay-of-worlds/verification/decay_of_worlds.py",
    "papers/24-particles-of-floor/paper.md",
    "papers/24-particles-of-floor/claims.md",
    "papers/24-particles-of-floor/RELEASE.md",
    "papers/24-particles-of-floor/verification/particles_of_floor.py",
    "verification/scripts/decay_of_worlds.py",
    "verification/scripts/particles_of_floor.py",
